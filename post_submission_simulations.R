...
for (ik in 1:100) {
  ...
  df = data.frame(beta1 = params[,1], beta2 = params[,2], beta3 = params[,3], gammasq = params[,4], dt = as.factor(params[,5]), time = params[,6])
...
load("varying_M_estimates_stochastic likelihood.Rda")
